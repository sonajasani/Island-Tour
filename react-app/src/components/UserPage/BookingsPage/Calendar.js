...
const Calendar = () => {
    ...
    const resortBookings = bookingsArr.filter(booking => {
        return Number(booking.resort_id) === Number(resortId)
    })
    ...
    const dates = bookingDates(resortBookings)
        ...
        <div className={open ? 'calendarWrapOpen' : 'calendarWrapClosed'}>
            ...
            <div className='detailsAndButton'>
                <div className='textAndInput'>
                    <p onClick={() => setOpen(open => !open)} className='inputBox'>Quick Book</p>
                </div>
            </div>
            {modal &&
